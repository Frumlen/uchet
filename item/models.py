...
class Category(models.Model):
    ...
    parent = models.ForeignKey("self", on_delete=models.DO_NOTHING, verbose_name="Родительская категория")
...
class ItemImage(models.Model):
    ...
    item = models.ForeignKey("item.Item", on_delete=models.DO_NOTHING, verbose_name="Связанный товар")
